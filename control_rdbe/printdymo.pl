...
#`gs -q -dNOPAUSE -dSAFER -g400x900 -r300x300  -sDEVICE=pbm -sOutputFile=- /tmp/dymo.ps -c quit |  pnmtoplainpnm   >/tmp/x$fil.pbm`;
#If really sending to dymo: use this:
#`gs -q -dNOPAUSE -dSAFER -g400x900 -r300x300  -sDEVICE=pbm -sOutputFile=- /tmp/dymo.ps -c quit | pnmtoplainpnm | pbm2lwxl 400 900 >/dev/usb/lp0`;
`gs -q -dNOPAUSE -dSAFER -g400x900 -r300x300  -sDEVICE=pbm -sOutputFile=- /tmp/dymo.ps -c quit `;
`CUPS_SERVER=134.104.69.30 lpr -P LabelWriter-450 /tmp/dymo.ps`;
}
